...
namespace DefectTracking.Migrations
{
    ...
    [Migration("20230323203711_CreatedNewRelationSHipForCommonDefectsTable")]
    partial class CreatedNewRelationSHipForCommonDefectsTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DefectTracking.Models.DeliveryDefects", b =>
                {
                    b.HasOne("DefectTracking.Models.CommonDefects", "CommonDefects")
                        ...
                        .HasForeignKey("CommonDefectId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_deliveryDefects_commonDefects");
            ...
            modelBuilder.Entity("DefectTracking.Models.ManufacturingDefects", b =>
                {
                    b.HasOne("DefectTracking.Models.CommonDefects", "CommonDefects")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_manufacturingDefects_commonDefects");
            ...
            modelBuilder.Entity("DefectTracking.Models.WarrantyDefects", b =>
                {
                    b.HasOne("DefectTracking.Models.CommonDefects", "CommonDefects")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_warrantyDefects_commonDefects");
