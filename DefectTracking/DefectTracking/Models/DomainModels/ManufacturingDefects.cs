...
{
    public class ManufacturingDefects
    {
		...
		public int SaveDetails()
        {
            ...
            string query = "INSERT INTO ManufacturingDefects(SerialNumber, UnitType, Display, CalibrationMissingCalibration, MechanicalAssemblyError, DeadorDyingBatteries, " +
                ...
                PCBBoardDefect + "', '" + SpeakerQuiet + "', '" + NoSound + "', '" + SwitchNotWorking + "', '" + 
				ButtonNotWorking + "', '" + EnclosureDefect + "', '" + Other + "', '" + OtherDesc + "', '" + ProblemDesc + "', '" + Date + "')";
